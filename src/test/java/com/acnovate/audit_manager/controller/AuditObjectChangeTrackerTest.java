...
import com.acnovate.audit_manager.dto.request.AuditObjectChangeResponseDto;
...
// TEST PASSED
    ...
    void testCreateAuditObjectChangeTracker() throws Exception {
        ...
        AuditLogActivityResponseDto returnedLog = mapper.convertValue(body.getData(), AuditLogActivityResponseDto.class);
    ...
    void testFindAll() throws Exception {
        ...
        List<AuditLogActivityResponseDto> returnedResps = mapper.convertValue(body.getData(), new TypeReference<List<AuditLogActivityResponseDto>>() {});
    ...
    void testFindOne() throws Exception {
        ...
        AuditLogActivityResponseDto returnedResponse = mapper.convertValue(body.getData(), AuditLogActivityResponseDto.class);
