...
public class SchedulingAuditReportResponse {
    ...
    public SchedulingAuditReportResponse(Long id, Integer reportId, String frequency, Integer schedulingHour, Integer schedulingMinute, String timeMarker, List<String> recipients) {
        this.id = id;
